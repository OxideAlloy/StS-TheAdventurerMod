...
public class FireWhip_TA extends AbstractDynamicCard {

    public static final String ID = TheAdventurerMod.makeID(FireWhip_TA.class.getSimpleName());
    public static final String IMG = makeCardPath("FireWhip_TA.png");
