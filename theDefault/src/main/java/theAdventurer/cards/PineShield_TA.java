...
public class PineShield_TA extends AbstractDynamicCard {
    ...
    public static final String ID = TheAdventurerMod.makeID(PineShield_TA.class.getSimpleName());
    public static final String IMG = makeCardPath("PineShield_TA.png");
    ...
    public PineShield_TA() {
        super(ID, IMG, COST, TYPE, COLOR, RARITY, TARGET);
        baseBlock = BLOCK;
        magicNumber = baseMagicNumber = MAGIC;
        tags.add(CustomTags.EGG_CARD);
        this.cardsToPreview = new GuardianEnt_TA();
    }
