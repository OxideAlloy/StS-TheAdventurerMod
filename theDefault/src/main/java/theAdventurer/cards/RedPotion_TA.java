...
public class RedPotion_TA extends AbstractDynamicCard {

    public static final String ID = TheAdventurerMod.makeID(RedPotion_TA.class.getSimpleName());
    public static final String IMG = makeCardPath("RedPotion_TA.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ObtainPotionAction(new AttackPotion()));
    }
