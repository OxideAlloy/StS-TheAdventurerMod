...
public class BrownMaskPower_TA extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;
    public static final String POWER_ID = TheAdventurerMod.makeID("BrownMaskPower_TA");
    ...
    public BrownMaskPower_TA(AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    //Functionality is in ForageAction
    ...
    public AbstractPower makeCopy() {
        return new BrownMaskPower_TA(owner, amount);
    }
}
