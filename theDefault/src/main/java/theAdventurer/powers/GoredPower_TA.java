...
public class GoredPower_TA extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;
    public static final String POWER_ID = TheAdventurerMod.makeID("GoredPower_TA");
    ...
    public GoredPower_TA(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public AbstractPower makeCopy() {
        return new GoredPower_TA(owner, source, amount);
    }
}
