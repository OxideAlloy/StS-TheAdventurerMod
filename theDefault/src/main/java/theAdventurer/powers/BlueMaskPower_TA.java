...
public class BlueMaskPower_TA extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;
    public static final String POWER_ID = TheAdventurerMod.makeID("BlueMaskPower_TA");
    ...
    public BlueMaskPower_TA(AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public AbstractPower makeCopy() {
        return new BlueMaskPower_TA(owner, amount);
    }
}
